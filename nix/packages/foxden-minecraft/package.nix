...
let
  ...
  modpack = {
    ...
    name = "server";
    hash = "sha256:c8dfa30cd96afc881349a83065fd681b1fa93fa851b496ba57cba2ba1048b8956";
  };
in
pkgs.stdenvNoCC.mkDerivation {
  ...
  mods = [
    ...
    (pkgs.fetchurl {
      ...
      hash = "sha256:8dfa30cd96afc881349a83065fd681b1fa93fa851b496ba57cba2ba1048b8956";
    })
  ];
  bluemapPacks = [
    (pkgs.fetchurl {
