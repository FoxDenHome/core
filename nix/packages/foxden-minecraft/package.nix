...
pkgs.stdenvNoCC.mkDerivation {
  ...
  mods = [
    ...
    (pkgs.fetchurl {
      url = "https://github.com/Doridian/BlueMap/releases/download/v5.16/bluemap-5.16-forge.jar";
      hash = "sha256:d939e61d47324358990ec8977980fb0f88d41654c3b7d6e427016e3b27ef6195";
    })
  ];
  bluemapPacks = [
    (pkgs.fetchurl {
