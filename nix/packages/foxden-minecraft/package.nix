...
pkgs.stdenvNoCC.mkDerivation {
  ...
  mods = [
    ...
    (pkgs.fetchurl {
      url = "https://github.com/Doridian/BlueMap/releases/download/temp/bluemap-emp-mc1.20-15-forge.jar";
      hash = "sha256:3fa83f6f801008b086982a8b0cdf7f9deb992478dc885e9b9d12ae3e1789a213";
    })
  ];
  bluemapPacks = [
    (pkgs.fetchurl {
