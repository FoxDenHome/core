...
in
{
  ...
  foxDen.hosts.hosts = {
    nas = mkV6Host {
      dns = {
        fqdn = "nas-offsite.foxden.network";
      };
    ...
    nzbget = mkV6Host {
      dns = {
        fqdn = "nzbget-offsite.foxden.network";
      };
      addresses = [
    ...
    jellyfin = mkV6Host {
      dns = {
        fqdn = "jellyfin-offsite.foxden.network";
      };
      webservice.enable = true;
      addresses = [
    ...
    kiwix = mkV6Host {
      dns = {
        fqdn = "kiwix-offsite.foxden.network";
      };
      webservice.enable = true;
      addresses = [
    ...
    deluge =
      let
        host = mkMinHost {
          dns = {
            fqdn = "deluge-offsite.foxden.network";
          };
          addresses = [
            "10.99.12.11/24"
