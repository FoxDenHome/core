  ...
  systemd.services.appliance-setup = {
    serviceConfig = {
      ...
      ExecStart = [
        ...
        "${pkgs.coreutils}/bin/mkdir -p /var/lib/appliance/data /run/appliance/tmp/.cache /run/appliance/tmp/.local /run/appliance/tmp/.config/fish /run/appliance/tmp/.kivy/icons /run/appliance/tmp/.kivy/logs /run/appliance/tmp/.kivy/mods"
      ];
    };
