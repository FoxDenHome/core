...
add dns=172.17.2.1 name=pdns root-dir=pdns-root interface=veth-dns logging=yes mounts=pdns-config,pdns-data start-on-boot=yes remote-image="git.foxden.network/foxden/pdnstiny:latest"
